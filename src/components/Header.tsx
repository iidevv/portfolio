...
const Header = () => {
    ...
    return (
        <header className="header">
            <div className="site-container site-container--horizontal">
                ...
                <nav className="nav">
                    <ul className="menu">
                        ...
                        <li className="menu__item"><Link className="menu__link" href="/#projects">Projects</Link></li>
                        <li className="menu__item"><Link className="menu__link" href="/#contacts">Contact</Link></li>
                    </ul>
